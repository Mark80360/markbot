...
from markbot.cron.types import CronJobState, CronSchedule
...
class CronTool(Tool):
    ...
    def description(self) -> str:
        return (
            "Create and manage real scheduled tasks that execute automatically at specified times. "
            "Use this tool when the user wants to schedule reminders, recurring tasks, or delayed actions. "
            "Do NOT create markdown files or documents to record tasks - use this tool directly to create actual scheduled jobs. "
            "Actions: add (create new schedule), list (view all schedules), remove (delete a schedule). "
