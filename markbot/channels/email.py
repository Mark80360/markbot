...
from markbot.utils.helpers import safe_filename
...
class EmailChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        base_subject = self._last_subject_by_chat.get(to_addr, "markbot reply")
    ...
    def _fetch_messages_once(
        ...
        try:
            ...
            for imap_id in ids:
                ...
                # --- Self-address filtering (prevent infinite loops) ---
    ...
    def _reply_subject(self, base_subject: str) -> str:
        subject = (base_subject or "").strip() or "markbot reply"
