...
3. Read `PROFILE.md` — your identity and user profile
...
- **MEMORY.md** — your curated long-term memory, like a human's long-term memory
- **memory/YYYY-MM-DD.md** — daily notes, raw logs of what happened

The system automatically:
- **Compacts** conversations when context gets too long (preserves recent messages, summarizes older ones)
- **Summarizes** conversations to daily markdown files in the background
- **Searches** memory semantically when you use `memory_search`
...
- Storage: `MEMORY.md` — auto-loaded into every LLM context in main sessions
...
- Auto-generated by the memory system after each conversation
- Raw logs of what happened each day
- Useful for reviewing recent activity
- The system manages these automatically — you don't need to create them

### 🔍 Memory Search

Use `memory_search` tool when you need to find something from past conversations:
- Searches MEMORY.md and all daily note files
- Semantic search (understands meaning, not just keywords)
- Returns relevant snippets with file paths
